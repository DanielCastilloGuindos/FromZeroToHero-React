			...
			<Header />
				<main>
					<Section
						...
						subtitle='Nosotros'
						id='nosotros' >
						<p className='max-w-3xl font-sans text-xl text-gray-500 text-center tracking-wider'>
					...
					<Section
						...
						<div className='grid grid-cols-3 gap-1.5 max-w-6xl'>
								{
					...
					<Section
						...
						id='contacto'
						extraClass='grid grid-cols-[33%_55%] gap-4 justify-center items-center max-w-6xl' >
					...
					<Section
						...
						<div className='grid grid-cols-3 gap-x-56 gap-y-10 max-w-6xl'>
					...
					<Section
						...
						extraClass='pb-20 bg-[url(/images/parallax.jpg)] bg-no-repeat bg-cover bg-center bg-fixed backdrop-contrast-150 before:w-full before:h-full before:bg-[#333]/40 before:absolute before:top-0 before:left-0 before:-z-10'
						extraTitleClass='text-white'>
							<div className='grid grid-cols-3 gap-20 max-w-6xl text-white'>
					...
					<Section
						...
						subtitle='No te quedes con la duda'>
							<div className='grid grid-cols-[65%_35%] w-full border-t border-gray-200'>
								<iframe
								...
								<aside className='grid justify-center items-center'>
